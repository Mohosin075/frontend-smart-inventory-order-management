...
export const { useLoginMutation, useSignupMutation, useForgotPasswordMutation, useResendOtpMutation, useVerifyAccountMutation, useResetPasswordMutation, useLogoutMutation, useRefreshTokenMutation } = authApi;
