            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                <div>
                    <h1 className="text-4xl font-bold tracking-tight text-slate-900">
                        Activity <span className="premium-gradient-text italic">Logs</span>
                    </h1>
                    <p className="text-slate-500 mt-2 font-medium">
                        Track all recent actions and changes made in the system.
                    </p>
                </div>
                <div className="glass-card px-6 py-4 rounded-[1.5rem] flex items-center gap-4 border-none shadow-xl shadow-indigo-500/5 bg-white">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="text-sm font-bold text-emerald-600 leading-none flex items-center gap-1">
                ...
                <div className="p-10">
                    {isLoading ? (
                        ...
                        <div className="space-y-0 relative before:absolute before:left-[27px] before:top-4 before:bottom-4 before:w-[1px] before:bg-slate-100">
                            {activities.map((activity: any, index: number) => (
                                ...
                                >
                                    ...
                                    <div className="bg-slate-50/30 p-8 rounded-[2rem] border border-transparent hover:border-indigo-100 hover:bg-white hover:shadow-2xl hover:shadow-indigo-500/5 transition-all duration-500 group text-left">
                                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                                            <div>
                                                <div className="text-lg font-bold text-slate-900 leading-tight group-hover:text-indigo-600 transition-colors uppercase tracking-tight text-left">
                                                    {activity.action}
                                                </div>
                                                <div className="flex items-center gap-2 mt-2">
                                                    <span className="text-[10px] font-bold text-indigo-500 uppercase tracking-widest bg-indigo-50 px-2 py-0.5 rounded-lg flex items-center gap-1">
                                                        <User className="w-3 h-3" /> {activity.metadata?.user || "System"}
                                                    </span>
                                            ...
                                            <div className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] bg-white px-4 py-2 rounded-xl shadow-sm border border-slate-50">
                                        ...
                                        <div className="flex items-center gap-3 text-xs text-slate-500 font-medium">
                                            ...
                                            <span className="uppercase tracking-widest opacity-60">Status: Action Completed</span>
                        ...
                        <div className="py-32 text-center">
                            ...
                            <h3 className="text-slate-900 font-bold text-2xl tracking-tight opacity-40">No Activities Found</h3>
                            <p className="text-slate-400 text-xs mt-3 uppercase tracking-[0.3em] font-medium">Recent activities will appear here once they occur.</p>
                        </div>
                    )}
                </div>
            </motion.div>
